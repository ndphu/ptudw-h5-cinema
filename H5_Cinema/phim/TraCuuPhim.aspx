...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div align="center" style="width: auto;" id="div_main" 
        dir="ltr">
        <asp:UpdatePanel ID="UpdatePanel2" runat="server">
            <ContentTemplate>
                <table border="Ridge" style="width: 100%">
                    <tr>
                        <td align="center">
                            <asp:Label ID="lb_KetQuaTraCuu" runat="server" Font-Size="20pt" 
                                ForeColor="#FFFFCC" style="font-size: x-large; font-weight: 700;" 
                                        ...
                                        <tr>
                                            <td align="left">
                                                <asp:LinkButton ID="lbt_XemLichChieu" runat="server" 
                                                    OnClick = "LBT_Click_XemLichChieu" ForeColor="#0099FF" 
                                                    CommandArgument='<%# Eval("MaPhim") %>'>Xem l&#7883;ch chi&#7871;u hi&#7879;n t&#7841;i...</asp:LinkButton>
                                            </td>
                                        </tr>
                                        <tr>
                                            <td align="left">
