...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div align="center" style="height: 1324px; width: auto;" id="div_main" 
        dir="ltr">
        ...
        <asp:DataList ID="dtl_pagging" runat="server" Height="38px" 
            onitemcommand="dtl_pagging_ItemCommand" RepeatDirection="Horizontal" 
            Width="88px">
            <ItemTemplate>
                <asp:LinkButton ID="lbt_PageIndex" runat="server" CommandName = "lbt_PageIndex"
                    CommandArgument='<%# Eval("PageIndex") %>' ForeColor="#33CC33" 
                    Text='<%# Eval("PageText") %>'></asp:LinkButton>
            </ItemTemplate>
        </asp:DataList>
        <asp:DataList ID="Th_KetQuaTraCuu" runat="server" Width="651px">
            <HeaderTemplate>
